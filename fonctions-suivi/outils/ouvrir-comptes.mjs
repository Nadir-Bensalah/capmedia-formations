...
const DEMO = {
  ...
  /* Aucune adresse réelle dans le dépôt : l'adresse du client de
     démonstration se passe en variable (DEMO_EMAIL). */
  client: {
    nom: process.env.DEMO_NOM || 'Client de démonstration',
    email: exiger('DEMO_EMAIL', "L'adresse du client de démonstration (un seul rôle par adresse)."),
    entreprise: process.env.DEMO_ENTREPRISE || 'Client de démonstration',
  },
