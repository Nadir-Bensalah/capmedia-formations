...
import { CLIENTS } from './portefeuille.mjs';
import { INTERNES } from './portefeuille-interne.mjs';
...
const ADRESSES = (process.env.ADRESSES || 'nadir.bensalah@outlook.fr,contact@capmedia.app,contact@nadirbensalah.fr,contact@nadirbensalah.com')
