...
const formulaireOrganisation = (o = {}) => `
  <div class="forme-rang">
    <div class="groupe"><label class="etiquette-champ" for="entreprise">Société</label><input class="champ" id="entreprise" name="entreprise" value="${echapper(o.entreprise || '')}" maxlength="120" placeholder="Perseus Capital"></div>
    <div class="groupe"><label class="etiquette-champ" for="nom">Contact principal</label><input class="champ" id="nom" name="nom" value="${echapper(o.nom || '')}" maxlength="120" placeholder="Sébastien Horemans"></div>
  </div>
  <div class="forme-rang">
